...
class Sequence(object):
    ...
    def make_xy(self, ii, jj):
        ...
        return xs, ys, dR, dt, ratio_test, mutual_nearest, cx1, cy1, f1, cx2, cy2, f2, kp_i, kp_j, [self.seq_index, ii, jj]


    def dump_datasets(self):
        ready_file = os.path.join(self.dump_dir, "ready")
        var_name = ['xs', 'ys', 'Rs', 'ts', 'ratios', 'mutuals', 'cx1s', 'cy1s', 'f1s', 'cx2s', 'cy2s', 'f2s', 'kp_i', 'kp_j', 'images']
        res_dict = {}
